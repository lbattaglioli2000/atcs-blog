...
<main role="main" class="container">
  <div class="row">
    <div class="col-md-8 blog-main">
      ...
      $stmt = $DB_con->prepare("SELECT * FROM `blogpost` INNER JOIN users ON users.user_id = blogpost.user_id;");
      $stmt->execute();
      ...
      ?>
        ...
        <div class="blog-post">
          ...
          <p class="blog-post-meta"><?php echo $post['post_timestamp']; ?> by <a href="#"><?php echo $post['user_name']; ?></a>
            <?php
            if(isset($_SESSION['user_session'])){
            ?>
            <a href="/edit/post/index.php?id=<?php echo $post['ID']; ?>" class="btn btn-sm btn-outline-primary"><i class="fas fa-pencil-alt"></i></a>
          <?php } ?>
          </p>
          <?php echo $post['user_posting']; ?>
        </div>
